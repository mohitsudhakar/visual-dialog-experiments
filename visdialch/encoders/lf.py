...
class LateFusionEncoder(nn.Module):
    ...
    def forward(self, batch):
        ...
        #print("question_features_for_dot: ", projected_ques_features.shape)
        #print("img_encoded: ", projected_image_features.shape)

        projected_ques_image = (
            projected_ques_features * projected_image_features
        )

        #print("product_question_image: ", projected_ques_image.shape)
        ...
        #print("attention_weights: ", image_attention_weights.shape)

        image_attention_weights = F.softmax(image_attention_weights, dim=-1)
        # print("Image attention weights after softmax: ", image_attention_weights.shape)
        ...
        #print("Multiplying image with weights:")
        #print("Repeating attention_weights: ", image_attention_weights.shape)
        # print("img: ", img.shape)
        # shape: (batch_size * num_rounds, img_feature_size)
        #print(" img_encoded_for_dot_product:", img.shape)
        attended_image_features = (image_attention_weights * img).sum(1)
        img = attended_image_features

        #print("Final attended features: ", img.shape)
