...
class LateFusionEncoder(nn.Module):
	...
	def forward(self, batch):
		...
		# Step 2: Encoding Question

		# BS x num_round x max_seq_len
		question_features = batch["ques"]


		# Combining Batch size and num_round
		...
		# Step 4: Doing attention on history
		...
		#  Step 5: Doing product of question and image for finding image attention
		...
		#  Doing product with image to find which proposal has the attention
		...
		# Step 7: Doing normalization

		fused_embedding = torch.tanh(self.fusion(fused_vector))


		# Step 8: Seperate Batch Size and num_round for giving to decoder
